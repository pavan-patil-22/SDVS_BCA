...
const sendEmail = async (to, subject, html) => {
  return await transporter.sendMail({
    from: `"SDVS'S BCA COLLEGE, Sankeshwar" <${process.env.EMAIL_USER}>`,
    to,
    subject,
    html,
  });
  ...
  try {
    ...
    const emailTemplate = `
      <div style="font-family: Arial; max-width:600px; margin:auto;">
        <h2>SDVS'S BCA COLLEGE, Sankeshwar</h2>
        <p>Hi <b>${message.name}</b>,</p>
        <p><b>Your Question:</b><br/>${message.message}</p>
        <p><b>Our Reply:</b><br/>${reply}</p>
        <br/>
        <p>Regards,<br/>SDVS'S BCA COLLEGE</p>
      </div>
    `;
